...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./C4.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/C4TEAM/Files_C4/master/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevC4W(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevC4W(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevC4W(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevC4W(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevC4W(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevC4W(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevC4W(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "C4Source")
...
--------------------------------------------------------------------------------------------------------------
function SourceC4(msg,data) -- بداية العمل
if msg then
...
SourceC4r = '❃∫ اهلا عزيزي\n ❃∫ انا بوت اسمي '..Namebot..'\n ❃∫ اختصاصي حمايه الكروبات\n ❃∫ من تكرار والسبام والتوجيه والخ…\n ❃∫ لتفعيلي اتبع الاخطوات…↓\n ❃∫ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ ❃∫ [قناة سورس البوت](http://t.me/C4Source)'
end 
send(msg.chat_id_, msg.id_, SourceC4r) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevC4W(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevC4W(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,C4_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ❃' and DevC4W(msg) then  
...
if text == 'تعطيل التواصل ❃' and DevC4W(msg) then  
...
if text == 'تفعيل البوت الخدمي ❃' and DevC4W(msg) then  
...
if text == 'تعطيل البوت الخدمي ❃' and DevC4W(msg) then  
...
if text == 'ضع كليشه ستارت ❃' and DevC4W(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ❃∫ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ❃' and DevC4W(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ❃' and DevC4W(msg) then 
...
if text == 'تحديث السورس ❃' and DevC4W(msg) then 
os.execute('rm -rf C4.lua')
os.execute('wget https://raw.githubusercontent.com/C4TEAM/C4/master/C4.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس سي فور\n ❃∫ الاصدار » { 1.3v}')
dofile('C4.lua')  
end
if text == 'الاصدار ❃' and DevC4W(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس سي فور \n ❃∫ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ❃' and DevC4W(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](t.me/C4Source) \n ❃∫ [قناه السورس](t.me/C4Source)')
end
if text == "ضع اسم للبوت ❃" and DevC4W(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ❃' and DevC4W(msg) then 
...
if text == 'المشتركين ❃' and DevC4W(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ❃' and DevC4W(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❃") and DevC4W(msg) then
...
if text == ("قائمه العام ❃") and DevC4W(msg) then
...
if text == ("قائمه الكتم العام ❃") and DevC4W(msg) then
...
if text=="اذاعه خاص ❃" and msg.reply_to_message_id_ == 0 and DevC4W(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ❃" and msg.reply_to_message_id_ == 0 and DevC4W(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ❃" and msg.reply_to_message_id_ == 0 and DevC4W(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ❃" and msg.reply_to_message_id_ == 0  and DevC4W(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ❃" and msg.reply_to_message_id_ == 0  and DevC4W(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ❃' and DevC4W(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ❃" and DevC4W(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ❃" and DevC4W(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'❃∫  عدد الكروبات الان » { '..#group..' }'..C4k..''..C4..'\n❃∫  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevC4W(msg) then
...
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'C4Source')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevC4W(msg) then
...
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'C4Source')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevC4W(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevC4W(msg) then
...
local C41_Msg = database:get(bot_id.."C41:Add:Filter:Rp2"..text..msg.chat_id_)   
if C41_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'C4Source')..') \n ❃∫ '..C41_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if C4_Msg and not Special(msg) then  
local C4_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if C4_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..C4_Msg.."] \n")
else
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/C4Source)}\n ❃∫ ["..C4_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](T.ME/C4Source)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevC4W(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevC4W(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevC4W(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevC4W(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ❃" and DevC4W(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ❃∫ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❃$") and DevC4W(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❃" and DevC4W(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ❃" and DevC4W(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ❃∫ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ❃" and DevC4W(msg) then  
...
database:sadd(bot_id.."C4:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."C4:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_C4 = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_C4 then 
names_C4 = database:smembers(bot_id.."C4:blocname"..msg.chat_id_) or ""
if names_C4 and names_C4[1] then 
for i=1,#names_C4 do 
if name_C4:match("(.*)("..names_C4[i]..")(.*)") then 
...
database:set(bot_id.."C4:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."C4:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."C4:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."C4:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."C4:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_C4a_new(C41,C42)
if C42 and C42.first_name_ then 
if C42.first_name_:match("(.*)"..database:get(bot_id.."C4:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."C4:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local C4_nnn = database:get(bot_id.."C4:nump"..msg.chat_id_) or 5
local C4_nnn2 = database:get(bot_id.."C4:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(C4_nnn2) == tonumber(C4_nnn) or tonumber(C4_nnn2) > tonumber(C4_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."C4:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❃∫ عزيزي >>["..C42.username_.."](https://t.me/"..(C42.username_ or "C4Source")..")\n❃∫ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."C4:teh"..msg.chat_id_).."} بجانب اسمك\n❃∫ عدد المحاولات المتبقيه {"..(tonumber(C4_nnn) - tonumber(C4_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_C4a_new)
end
end
...
local C4ChengName = database:get(bot_id.."C4:Cheng:Name"..data.id_)
if not data.first_name_ then 
if C4ChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..C4ChengName..']')
database:del(bot_id.."C4:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if C4ChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."C4:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local C4ChengUserName = database:get(bot_id.."C4:Cheng:UserName"..data.id_)
if not data.username_ then 
if C4ChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..C4ChengUserName..']')
database:del(bot_id.."C4:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if C4ChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."C4:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local C4ChengPhoto = database:get(bot_id.."C4:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if C4ChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."C4:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if C4ChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."C4:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
≪━━━━━━𝘽𝙆━━━━━━≫
 ❃∫ ↬𝐁𝐎𝐘𝐊𝐀 𝐓𝐄𝐀𝐌
≪━━━━━━𝘽𝙆━━━━━━≫
 ❃∫ ↬[Channel C4](t.me/C4Source) 
≪━━━━━━𝘽𝙆━━━━━━≫
 ❃∫ ↬[Information](t.me/C4Source)
≪━━━━━━𝘽𝙆━━━━━━≫
 ❃∫ ↬[DEVELOPER](t.me/C4Source)
≪━━━━━━𝘽𝙆━━━━━━≫
 ❃∫ ↬[orders C4](t.me/source_C4)
≪━━━━━━𝘽𝙆━━━━━━≫
...
if text == 'رفع نسخه الاحتياطيه' and DevC4W(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'C4Source')..') \n ❃∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'C4Source')..') \n ❃∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevC4W(msg) then    
dofile('C4.lua')  
send(msg.chat_id_, msg.id_, ' ❃∫ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevC4W(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevC4W(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevC4W(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevC4W(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevC4W(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevC4W(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevC4W(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevC4W(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevC4W(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevC4W(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevC4W(msg) then
...
if text == 'الملفات' and DevC4W(msg) then
t = ' ❃∫ ملفات السورس سي فور ↓\n≪━━━━━━𝘽𝙆━━━━━━≫ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevC4W(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/C4TEAM/Files_C4/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات سي فور\n ❃∫ ملفات السورس ↓\n≪━━━━━━𝘽𝙆━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━𝘽𝙆━━━━━━≫\n ❃∫ علامة تعني { ✓ } ملف مفعل\n ❃∫ علامة تعني { ✘ } ملف معطل\n ❃∫ قناة سورس سي فور ↓\n".." ❃∫ [اضغط هنا لدخول](t.me/C4Source) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevC4W(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/C4TEAM/Files_C4/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('C4.lua')  
else
send(msg.chat_id_, msg.id_," ❃∫ عذرا الملف لايدعم سورس سي فور \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevC4W(msg) then
...
if text == "مسح الملفات" and DevC4W(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ❃∫ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevC4W(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevC4W(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "C4Source")
...
function Function_C4(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_C4, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_C4, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'C4Source')..')'
status  = '\n ❃∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❃∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'C4Source')..')'
...
database:set(bot_id.."C41:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."C41:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❃∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."C41:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."C41:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."C41:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."C41:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❃∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."C41:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."C41:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."C41:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."C41:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❃∫ ارسل الكلمه الان")  
database:set(bot_id.."C41:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."C41:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."C41:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."C41:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."C41:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."C41:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."C41:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."C41:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."C41:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❃∫ قائمة المنع \n≪━━━━━━𝘽𝙆━━━━━━≫\n"
for k,v in pairs(list) do  
local C4_Msg = database:get(bot_id.."C41:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..C4_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevC4W(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ❃∫ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevC4W(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❃∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'C4Source')..')'..'\n ❃∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevC4W(msg) then  
...
if text == 'تعطيل الاذاعه' and DevC4W(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سي فور').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سي فور')
local C4_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..C4_Msg[math.random(#C4_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevC4W(msg) then 
...
if text == ("مسح ردود المطور") and DevC4W(msg) then 
...
if text == ("ردود المطور") and DevC4W(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ❃∫ قائمة ردود المطور \n≪━━━━━━𝘽𝙆━━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevC4W(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevC4W(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سي فور').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevC4W(msg) then   
...
if text == 'تعطيل المغادره' and DevC4W(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'C4')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'C4Source')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
C4dx(msg.chat_id_, msg.id_, ' ❃∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❃∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❃∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❃∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevC4W(msg) then
...
zh = https.request('https://rudi-dev.tk/Amir1/C4.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❃∫ قائمه الزخرفه \nٴ❃∫ٴ≪━━━━━━𝘽𝙆━━━━━━≫ٴ❃∫○ٴ \n"
i = 0
...
gk = https.request('https://rudi-dev.tk/Amir2/C4.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/C4.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سي فور')
...
C4 = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(C4)
...
------------------------------------------------------------------------
local c4_0BoT = database:get(bot_id.."C41:Add:Filter:Rp2"..text..result.chat_id_)   
if c4_0BoT then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..c4_0BoT.."] \n") 
...
------------------------------------------------------------------------
if text then
local C41_Msg = database:get(bot_id.."C41:Add:Filter:Rp2"..text..result.chat_id_)   
if C41_Msg then    
send(msg.chat_id_, msg.id_," ❃∫ "..C41_Msg)
